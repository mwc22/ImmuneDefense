...
public class MultiPlayer extends TowerDefenseModel {
...
//        public MultiPlayer(String playerName, GameMap gm, int teamId) {
//                m_gameOver = false;
//                m_gameMap = gm;
...
//                m_map = new MultiMap(gm.getPaths(), m_teamId, width, height);
//                m_teamId = teamId;
////                m_client = new Client(SERVER_PORT, playerName, teamId, this);
//                m_clientRunner = new Thread(m_client);
//                m_clientRunner.start();
//        }
        
        public MultiPlayer(PlayerSocket ps, GameMap gm, int teamId) {
        	m_gameOver = false;
            m_gameMap = gm;
